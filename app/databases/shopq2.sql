...
-- Дамп данных таблицы shop.admins: ~2 rows (приблизительно)
/*!40000 ALTER TABLE `admins` DISABLE KEYS */;
REPLACE INTO `admins` (`name`, `password`) VALUES
	('Maksim', 'bf1d97f08f27bc40e5736c5d70a7f5ce'),
	('Tural', '39b51f8a63e345a74109222fd6a5ea98');
/*!40000 ALTER TABLE `admins` ENABLE KEYS */;

-- Дамп данных таблицы shop.categories: ~10 rows (приблизительно)
...
-- Дамп данных таблицы shop.orders: ~30 rows (приблизительно)
/*!40000 ALTER TABLE `orders` DISABLE KEYS */;
REPLACE INTO `orders` (`id`, `id_user`, `status`, `date_order`) VALUES
...
-- Дамп данных таблицы shop.order_property: ~30 rows (приблизительно)
/*!40000 ALTER TABLE `order_property` DISABLE KEYS */;
REPLACE INTO `order_property` (`id_order`, `id_product`, `price`, `count`) VALUES
	(1, 5, 880.99, 1),
	(2, 55, 4050.99, 1),
	(3, 42, 549.99, 1),
	(4, 32, 451, 1),
...
-- Дамп данных таблицы shop.products: ~80 rows (приблизительно)
/*!40000 ALTER TABLE `products` DISABLE KEYS */;
REPLACE INTO `products` (`id`, `title`, `mark`, `count`, `price`, `description`, `id_catalog`, `link`) VALUES
...
-- Дамп данных таблицы shop.users: ~31 rows (приблизительно)
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
REPLACE INTO `users` (`id`, `name`, `lastname`, `birthday`, `email`, `password`, `is_active`, `reg_date`, `last_update`) VALUES
	(1, 'Мария', 'Таманаева', '1956-02-24', 'mariya_tamaneva@list.ru', 'bb440d1516bfdcbaa9291150b26821a3', 0, '2015-01-06 02:07:07', '2015-01-06 02:07:07'),
	(2, 'Юрий', 'Никитин', '1948-07-26', 'yuri_nikitin@bk.ru', '5fe28415cd9a25edf7edf195d22c201b', 1, '2015-01-19 23:17:03', '2015-01-19 23:17:03'),
	(3, 'Ирина', 'Жигульская', '1965-08-17', 'irina_jigulskaya@inbox.ru', '443a3ae86d6e84100cef795990348fa8', 0, '2015-01-21 16:03:04', '2015-09-24 00:00:00'),
	(4, 'Виктор', 'Журавлев', '1965-03-24', 'viktor_juravlev@mail.ru', 'b9f69b2e5d53364785dd67483589b263', 0, '2015-02-21 18:08:03', '2015-02-21 18:08:03'),
	(5, 'Максим', 'Липовик', '1978-12-15', 'maksim_lipovik@bk.ru', '764cc32b989d49c0d12cade13311e1d0', 1, '2015-02-26 20:03:44', '2015-02-26 20:03:44'),
	(6, 'Роман', 'Костюченко', '1989-12-15', 'roman_kostyuchenko@list.ru', 'd26f87b30e2600724f63fd3f4569c022', 0, '2015-02-28 19:17:43', '2015-02-28 19:17:43'),
	(7, 'Евгений', 'Скрыпников', '1954-09-30', 'evgeniy_skripnikov@mail.ru', '386fb3dd746bb7cbfab2e9c04ebf79bf', 0, '2015-03-13 07:19:37', '2015-03-13 07:19:37'),
	(8, 'Дмитрий', 'Сокольцов', '1975-01-13', 'dmitri_sokolcov@inbox.ru', '1cd67667b4f0aba3218acd70fe175476', 1, '2015-03-18 21:35:29', '2015-03-18 21:35:29'),
	(9, 'Дмитрий', 'Гололобов', '1986-08-23', 'dmitri_qolobov@bk.ru', '4c24990c0615c80d403e60dbbb52bf2e', 1, '2015-03-23 10:06:45', '2015-03-23 10:06:45'),
	(10, 'Владимир', 'Киселев', '1990-08-05', 'vladimir_kiselev@mail.ru', 'f605c15a4e289ceec990e9ef82dfbe98', 0, '2015-04-22 02:46:36', '2015-04-22 02:46:36'),
	(11, 'Константин', 'Добецкий', '1988-09-12', 'konstantin_dobeckiy@bk.ru', '7a7b1c49a304253571924e798ff70786', 1, '2015-04-30 12:09:23', '2015-04-30 12:09:23'),
	(12, 'Сергей', 'Терешков', '1993-05-15', 'sergey_tereshkov@bk.ru', '6155e99add2a568458c7df84972421a7', 1, '2015-05-15 18:03:24', '2015-05-15 18:03:24'),
	(13, 'Андрей', 'Бобрышов', '1975-10-23', 'andrey_bobrishov@mail.ru', 'a3c7c47ece6bac9b1219054f1b888521', 1, '2015-05-22 17:04:29', '2015-05-22 17:04:29'),
	(14, 'Александр', 'Бондаренко', '1981-12-17', 'aleksandr_bondarenko@list.ru', 'd793546dc638d3fb356df9535e3b67ca', 1, '2015-05-22 22:07:38', '2015-05-22 22:07:38'),
	(15, 'Роман', 'Карпов', '1968-10-29', 'roman_karpov@mail.ru', 'b3a376ec376573f8a8b8a080443803f9', 0, '2015-05-24 14:19:17', '2015-05-24 14:19:17'),
	(16, 'Денис', 'Назаров', '1989-10-10', 'denis_nazarov@inbox.ru', '8c52ff1adaf1fdeacef3c58172743a2e', 1, '2015-05-25 04:10:52', '2015-05-25 04:10:52'),
	(17, 'Алексей', 'Буквин', '1992-05-17', 'aleksey_bukvin@mail.ru', '84f004e2de46b05d147cd853fa5c1e88', 1, '2015-05-25 18:22:41', '2015-05-25 18:22:41'),
	(18, 'Александр', 'Хрюков', '1980-06-23', 'aleksandr_xrukov@bk.ru', 'de85fc8b0cd0f78da93dcf684ba8fea6', 1, '2015-06-01 13:25:06', '2015-06-01 13:25:06'),
	(19, 'Алексей', 'Минжуков', '1951-10-05', 'aleksey_minjukov@inbox.ru', 'a46da4a5a0b193fcdf5d7a6fa4817c49', 1, '2015-06-14 19:35:35', '2015-06-14 19:35:35'),
	(20, 'Полина', 'Данилина', '1990-11-15', 'polina_danilina@mail.ru', '815a2e988dbbdcba6c5dad45d70bb82f', 1, '2015-06-26 12:02:04', '2015-06-26 12:02:04'),
	(21, 'Антон', 'Мясников', '1970-04-01', 'anton_myasnikov@bk.ru', '1b5fab1d1b205d192d575ee5326d5e0b', 1, '2015-07-02 23:10:34', '2015-07-02 23:10:34'),
	(22, 'Ярослав', 'Чуйков', '1989-04-02', 'yaroslav_chuykov@list.ru', '72c95aee2b2ccd7e9bf694764ecace84', 0, '2015-07-04 22:08:12', '2015-07-04 22:08:12'),
	(23, 'Фанис', 'Ганиев', '1985-07-18', 'fanis_qaniyev@mail.ru', 'dc129da84eabe536db59912dee0a8f21', 0, '2015-07-16 11:39:51', '2015-07-16 11:39:51'),
	(24, 'Вадим', 'Черемисин', '1991-05-25', 'vadim_cheremisin@list.ru', '414d1aeb3684f4b36a04fd7f31b3072c', 1, '2015-07-19 12:58:12', '2015-07-19 12:58:12'),
	(25, 'Константин', 'Сальников', '1966-03-21', 'konstantin_salnikov@bk.ru', 'a2ba4b83f9458cb8882bae5ee4a686fe', 0, '2015-07-27 19:25:03', '2015-07-27 19:25:03'),
	(26, 'Анна', 'Колмакова', '1954-05-25', 'anna_kolmakova@list.ru', 'f7b17dc0f47d1e8ba075e8fdeb300960', 1, '2015-08-05 15:02:29', '2015-08-05 15:02:29'),
	(27, 'Александр', 'Танаев', '1982-11-04', 'aleksandr_tanaev@mail.ru', 'e8e32e350fe9af4c96f6d8b61edb0543', 0, '2015-08-09 15:14:50', '2015-08-09 15:14:50'),
	(28, 'Сергей', 'Егоров', '1991-10-12', 'sergey_eqorov@inbox.ru', '79942ef5f99a251a2222cff2b27e7714', 1, '2015-08-12 11:23:11', '2015-08-12 11:23:11'),
	(29, 'Владислав', 'Николаев', '1992-10-05', 'vladislav_nikolayev@mail.ru', 'c7a8d374cf93af8824ff8a55b562ca1c', 0, '2015-08-18 14:46:43', '2015-08-18 14:46:43'),
	(30, 'Артём', 'Курзяков', '1985-02-28', 'artyom_kurzyakov@list.ru', '17fc658145ddf7e88c22f403d12dd329', 1, '2015-08-25 04:15:34', '2015-08-25 04:15:34'),
	(35, 'Jason', 'Statham', '2015-09-01', 'statham@jason.ru', 'f691cfd62d4075e532fe17630f9e65b4', 0, '2015-09-19 00:00:00', '2015-09-19 00:00:00');
